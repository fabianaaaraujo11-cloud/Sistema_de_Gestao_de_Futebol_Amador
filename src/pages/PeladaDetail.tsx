...
import { ChevronLeft, Plus, Trash2, CircleCheck as CheckCircle2, Circle, ArrowUp, ArrowDown, Users, Search, Loader as Loader2, X, Play, DollarSign } from "lucide-react";
...
const PeladaDetail = () => {
  ...
  const filteredAvailable = availablePlayers.filter(p =>
    ...
    !pelada?.inscritos.some(i => String(i.jogador) === String(p.id))
  );
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <table className="min-w-full divide-y divide-gray-100">
                <thead className="bg-gray-50">
                  <tr>
                    ...
                    <th className="px-6 py-3 text-center font-semibold text-gray-500 uppercase tracking-wider">Pago</th>
                    <th className="px-6 py-3 text-right font-semibold text-gray-500 uppercase tracking-wider">Ações</th>
                  </tr>
                </thead>
                  ...
                  {pelada.inscritos.map((pj, index) => (
                    <tr key={pj.id} className={cn("hover:bg-gray-50 transition-colors", !pj.presenca_confirmada && "opacity-60")}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-center">
                        <button onClick={() => handleTogglePresence(pj.id, pj.presenca_confirmada)}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-center">
                        <button onClick={() => handleTogglePayment(pj.id, pj.pagamento_confirmado)}>
        ...
        <div className="space-y-4">
          ...
          <h2 className="text-lg font-bold text-gray-900 pt-6">Rateio de Custos</h2>
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 space-y-4 text-sm">
            <div className="flex justify-between pb-3 border-b border-gray-50">
